...
$events = $req->fetchAll();
  ...
  $connect = new PDO('mysql:host=localhost;dbname=tbatmpc', 'root', '');
  ...
  foreach($result as $row)
    {
      $output2 .= '<option value="'.$row['unit'].'">'.$row["unit"].'</option>';
    }
...
<div id ="blackmessage" class="col-lg-12">
	<div id="hen"><h2>The Best Vehicle Rental Service in Baguio City</h2></div>
	

</div>


		<button type="button" id="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#addbuttonmodal">Reservation Form</button>	
	...
	<div class="col-lg-6">
			...
			<div class="container-fluid">            
				<p>
					...
					Loren ipsumLoren ipsumLoren ipsumLoren ipsumLoren 
				</p>
				<p>
					Loren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsumLoren ipsum
					Loren ipsumLoren ipsumLoren ipsumLoren ipsumLoren 
	    ...
	    <form id="form1">	
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	          ...
	          <input style="width:46%; display:inline;" type="firstname" class="form-control" id="firstname" placeholder="Enter First Name" name="firstname">
	          <input style="width:46%; display:inline;" type="lastname" class="form-control" id="lastname" placeholder="Enter Last Name" name="lastname">
	          </div><br>
	          ...
	          <input style="width:17.5%; display:inline;" type="days" class="form-control" id="days" placeholder="days" name="days">
	          </div><br>
 ...
 <div class=container-fluid>
    ...
    <div class="container">
        ...
        <div class="row">
        	<div class="col-lg-6">
        		<br><br><br><br>
        		<p>lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum </p><br>
